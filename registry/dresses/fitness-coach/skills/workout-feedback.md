...
- Read today's **## {{memory.dailySection}}** section from daily memory to see what plan was sent
...
Update the **## {{memory.dailySection}}** section in today's daily memory with their feedback: completion status, how they felt, and any adjustments for next time.
