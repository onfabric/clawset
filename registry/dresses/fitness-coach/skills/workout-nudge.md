...
- Only nudge if no workout schedule was sent today (check **## {{memory.dailySection}}** in today's daily memory)
...
Note in today's **## {{memory.dailySection}}** section that a nudge was sent, so you don't repeat it.
