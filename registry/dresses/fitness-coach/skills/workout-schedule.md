...
- Read today's and yesterday's daily memory under **## {{memory.dailySection}}** for recent history
...
Write a brief summary in today's daily memory under the **## {{memory.dailySection}}** section: what plan was sent and any notes.
